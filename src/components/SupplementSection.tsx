...
const SupplementSection: React.FC<SupplementSectionProps> = ({ userProfile }) => {
  ...
  const getPersonalizedDosages = () => {
    ...
    const isAggressiveCut = userProfile.goal === 'fat-loss';
    ...
    <div className="space-y-4">
      <div className="text-center py-4">
        ...
        <p className="text-slate-600">
          Dosaggi scientifici per {userProfile.currentWeight}kg • Timing ottimale • Performance +30%
        </p>
      </div>

      {/* Progress Overview Personalizzato */}
      ...
      <Card className="p-4 bg-blue-50 border-blue-200">
        <h3 className="font-semibold text-blue-800 mb-2 flex items-center">
          ...
          📚 Personalizzazione per {userProfile.currentWeight}kg
        </h3>
        <div className="text-sm text-blue-700 space-y-1">
          <p>• <strong>Proteine:</strong> {dosages.whey}g = {Math.round((dosages.whey / userProfile.currentWeight) * 10) / 10}g/kg per sintesi ottimale</p>
